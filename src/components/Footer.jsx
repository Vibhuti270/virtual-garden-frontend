...
const Footer = () => {
  return (
    <footer className="bg-sec-color text-main-color py-12 px-4 mb-0 md:px-10 shadow-xl border-t-2 border ">
      <div className="flex flex-col md:flex-row justify-between">
        ...
        <div className="md:w-1/3 text-center md:text-left">
          <div className="flex items-center justify-center md:justify-start mb-4">
            ...
            <p className="text-lg">
              <span className="block">Bhagwan Parshuram Institute of Technology,</span>
              Delhi, 110089 (India)
            </p>
          </div>
          <div className="flex items-center justify-center md:justify-start mb-4">
