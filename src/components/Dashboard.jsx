...
const Dashboard = () => {
  ...
  const apiKey = "6d83eed5acc640d0bc0a2e53e306773a"; // Replace with your Google News API Key
  ...
  const fetchNewsArticles = async () => {
    ...
    try {
      const response = await axios.get(
        `https://newsapi.org/v2/everything?q=ayurveda OR herb&language=en&apiKey=${apiKey}&pageSize=5` // Updated query for filtering
      );
