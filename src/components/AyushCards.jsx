...
const WellnessOptions = () => {
  const offerings = [
    {
      title: "Ayurveda",
      description: "Ayurveda is an ancient medicine focusing on holistic health, using natural treatments like nutrients and herbs to balance life.",
      bgColor: "bg-green-50",
    ...
    },
    {
      ...
      description: "Embrace the harmonious union of body and mind through Yoga and natural therapies for a balanced, healthier you.",
    ...
    {
      title: "Unani",
      description: "Emphasizes holistic healing through traditional natural remedies, herbal treatments, and lifestyle balance to promote overall well-being.",
    ...
    {
      title: "Siddha",
      description: "Siddha medicine is an ancient South Indian system focusing on holistic, individualized treatment with natural substances.",
      bgColor: "bg-red-50",
    ...
    {
      title: "Homeopathy",
      description: "Homeopathy focuses on natural healing by using highly diluted remedies to stimulate the body's self-healing abilities and restore balance.",
      bgColor: "bg-teal-50",
