...
const FirstPage = ({ onGetStartedClick }) => {
    ...
    return (
        ...
        <div className="flex justify-center items-center h-screen mt-4">
            <div className="bg-sec-color m-2 md:m-16 p-6 md:p-10 shadow-lg rounded-lg flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8 h-[85vh] md:h-[80vh] items-center justify-center">
                {/* Text Section */}
